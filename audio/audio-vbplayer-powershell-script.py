...
# ⚙️ Run PowerShell Script for Audio Setup
def setup_audio():
    ...
    try:
        ...
        print("✅ Audio settings configured successfully!")
    except subprocess.CalledProcessError as e:
        print(f"❌ Error setting up audio: {e}")
        print("⚠️ Please make sure VB-Audio Virtual Cable is installed and try again.")
...
# 🛠️ **Run Audio Setup Before Capturing Sound**
