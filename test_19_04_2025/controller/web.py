...
@app.route("/check_led_points")
def check_led_points():
    led_path = os.path.join(os.path.dirname(__file__), "led_points.json")
    return jsonify({"exists": os.path.exists(led_path)})
